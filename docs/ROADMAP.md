...
- it maps existing ADL examples to planned starter file paths, dry-run file manifest fixture summaries, template contract fixture summaries, preview bundle summaries, blocked gates, validation state, safety policy state, and non-goals without writing files or rendering templates;
