...
REQUIRED_BUNDLE_REFERENCES = [
    ...
    "tests/BETA-EXTERNAL-SERVICE-APPROVAL-INTAKE-REPORT.md",
    "tests/BETA-EXTERNAL-SERVICE-APPROVAL-AUTHORIZATION-REPORT.md",
    ...
    "tests/test_beta_external_service_approval_intake.py",
    "tests/test_beta_external_service_approval_authorization.py",
