...
REQUIRED_POST_MARKERS = [
    ...
    "how #220 prototype/beta feedback should be separated from docs-only corrections",
    "Do not publish this post externally until the project maintainer approves",
