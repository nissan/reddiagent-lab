...
For a human-readable project entrypoint, start with `docs/REDDIAGENT-VISION-ROADMAP.md`. For the high-level system view, read `docs/REDDIAGENT-ARCHITECTURE.md`. For durable architectural decisions, use the ADR register at `docs/adr/0000-adr-index.md`.
