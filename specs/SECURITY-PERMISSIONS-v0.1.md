...
- ADL v0.2 required eval gates with missing/failing/mismatched evidence, warning severity, non-blocking failure behavior, or non-fail default status: fail completion compatibility.
