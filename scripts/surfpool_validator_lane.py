...
def collect_findings(scenario: dict[str, Any]) -> list[dict[str, str]]:
    ...
    require(scenario.get("paymentRequested") is False, "paymentRequested", "Payment access is not allowed for local validator lane evidence.")
    require(scenario.get("paymentRailRequested") is False, "paymentRailRequested", "Payment rail access is not allowed for local validator lane evidence.")
    require(scenario.get("paymentAccessRequested") is False, "paymentAccessRequested", "Payment access is not allowed for local validator lane evidence.")
    ...
    require(scenario.get("settlementRequested") is False, "settlementRequested", "Settlement access is not allowed for local validator lane evidence.")
